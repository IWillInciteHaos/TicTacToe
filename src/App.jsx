...
function App() {
  ...
  const [history, setHistory] = useState([ {squares: Array(9).fill(null), isONext : false}])
  ...
  //   
    ...
    return (
      <div className="app">
        ...
        <Board className="board" squares = {gamingBoard.squares} handleSquareClick = {handleSquareClick}/>
        <h2>Game history</h2>
